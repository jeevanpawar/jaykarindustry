<?php
	...
	$c_up=$_REQUEST['c_id2'];
	$c_qry_f="select * from suppliers where s_id=".$c_up;
...
<br />
		<div class="hr"><center>Update suppliers Details</center></div>
        <br />
        <div>
        <form action="update_suppliers.php?suppliers_id=<?php echo $c_up; ?>" method="post" >
        <table class="newtab">
        <tr>
        <td>Name:</td>
        <td>
