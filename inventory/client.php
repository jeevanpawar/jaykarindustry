...
<div id="sub-header">
        ...
        <tr class="search_res">
        <td class="info">
        <span class="newbook"><a href="#" rel="popuprel" class="popup new">Add New Client</a> </span>
        </td>
        </tr>
        </table>
        ...
        <td><input class="q_in" name="t1" type="text"></td>
        </tr>
        <tr><td>Address:</td>
        <td><textarea class="q_add" name="t2"></textarea></td>
        </tr>
        <tr>
        <td>Mobile No:</td>
        <td>
